...
## 2024-05-22 - Always Visible Discovery
**Learning:** Hiding features that require setup (like Prompt Enhancer) leads to zero discovery. Users can't configure what they don't know exists.
**Action:** Always show the entry point for the feature. If it's not configured, the action should trigger a "Setup" flow (or guidance) instead of doing nothing or being hidden.
