...
## 2025-05-25 - OTA Integrity Gap
**Vulnerability:** The OTA update mechanism relied solely on HTTPS transport security, lacking binary integrity verification (checksums) despite documented intent.
**Learning:** Security features described in documentation or memory may not match the actual codebase ("trust but verify").
**Prevention:** Explicitly implement and test integrity checks (e.g., SHA256) for all external binary downloads, regardless of transport security.
