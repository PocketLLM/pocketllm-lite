...
class _ChatBubbleState extends ConsumerState<ChatBubble> {
  ...
  Widget build(BuildContext context) {
    ...
    // Optimization: Pre-build expensive content (Images & Markdown) outside ValueListenableBuilder
    // to avoid rebuilding them when the starred status changes (which triggers the listener).
    final List<Widget> messageContentWidgets = [
