...
class _ChatBubbleState extends ConsumerState<ChatBubble> {
  ...
  Widget build(BuildContext context) {
    ...
    // Optimize performance: Construct the expensive message content widget (Images + Markdown)
    // outside of the ValueListenableBuilder. This ensures that when the starred messages list
    // changes (triggering the builder), we reuse the already built content widget instead of
    // rebuilding/re-parsing Markdown.
                    ...
                    child: RepaintBoundary(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            child!, // Reuse the pre-built expensive content
                            // Timestamp display
                            Padding(
