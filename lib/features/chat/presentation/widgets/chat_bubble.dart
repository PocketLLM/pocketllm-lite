...
class _ChatBubbleState extends ConsumerState<ChatBubble> {
  ...
  Widget build(BuildContext context) {
    ...
    // Optimization: Build message content (Images + Text/Markdown) outside the ValueListenableBuilder
    // to prevent expensive re-parsing/re-rendering when star status changes.
                    ...
                    child: RepaintBoundary(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            child!, // Insert pre-built content
                            // Timestamp display
                            Padding(
