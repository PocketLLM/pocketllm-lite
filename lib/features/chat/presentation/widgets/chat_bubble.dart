                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Timestamp display
                        // Optimized: Scoped listener to only rebuild the timestamp row when starred status changes.
                        // This prevents expensive MarkdownBody rebuilds on frequent star updates.
                        Padding(
                          padding: const EdgeInsets.only(top: 8.0),
                          child: ValueListenableBuilder(
                            valueListenable: storage.starredMessagesListenable,
                            builder: (context, _, __) {
                              final isStarred = storage.isMessageStarred(
                                message,
                              );
                              return Row(
                                mainAxisSize: MainAxisSize.min,
