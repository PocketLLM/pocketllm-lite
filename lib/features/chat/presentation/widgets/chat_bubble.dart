...
class _ChatBubbleState extends ConsumerState<ChatBubble> {
  ...
  Widget build(BuildContext context) {
    ...
    // Optimize: Pre-build the expensive content (Images + Markdown/Text) outside the
    // ValueListenableBuilder. This ensures we don't re-parse Markdown or re-layout
    // images when only the starred status changes (which triggers the builder).
    ...
    return ValueListenableBuilder(
      ...
      child: contentWidget,
      builder: (context, _, cachedContent) {
