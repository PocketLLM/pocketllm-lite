...
class ChatNotifier extends Notifier<ChatState> {
  ...
  Future<void> sendMessage(String text, {List<String>? images}) async {
    ...
    try {
      ...
      // Optimize: Use StringBuffer to avoid O(N^2) string allocations during concatenation
      ...
      await for (final chunk in stream) {
        ...
        assistantContentBuffer.write(chunk);
        ...
        if (lastUiUpdateTime == null ||
          ...
          state = state.copyWith(
            streamingContent: assistantContentBuffer.toString(),
          );
          lastUiUpdateTime = now;
        }
      }

      final finalContent = assistantContentBuffer.toString();
