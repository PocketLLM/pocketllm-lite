        ...
        child: Column(
          ...
          children: [
            ...
            _buildStep(
              context,
              '1',
              'Install Ollama on a supported trusted computer, or import a compatible local GGUF',
            ),
            const SizedBox(height: 8),
            _buildStep(
              context,
              '2',
              'Start Ollama and expose it only to the network you trust',
            ),
            const SizedBox(height: 8),
            _buildStep(
              context,
              '3',
              'Configure the endpoint and select a model the runtime reports',
            ),
          ],
        ),
      ),
