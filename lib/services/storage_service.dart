...
class StorageService {
  ...
  Future<void> renameTag(String oldTag, String newTag) async {
    ...
    // Iterate through all chats and update the tag
    for (final chatId in map.keys) {
      ...
      if (tags.contains(oldTag)) {
        ...
        // If map[chatId] is reference to the same list object, it's updated.
  ...
  Future<void> deleteTag(String tag) async {
    ...
    if (changed) {
      await saveChatTagsMap(map);
      await logActivity('Tag Deleted', 'Deleted tag "$tag"');
    }
  }
