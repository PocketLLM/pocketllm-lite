...
class StorageService {
  ...
  // Define allowed settings keys as a static constant to ensure consistency between import and export.
  ...
  Future<Map<String, int>> importData(Map<String, dynamic> data) async {
    ...
    if (data['settings'] != null) {
      ...
      for (final entry in settings.entries) {
        // Security: Only import allowed settings to prevent bypassing usage limits or injecting internal keys
