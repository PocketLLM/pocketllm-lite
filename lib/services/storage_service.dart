      ...
      for (final message in session.messages) {
        if (message.images != null && message.images!.isNotEmpty) {
          ...
          for (final img in message.images!) {
            ...
            // Append index to ensure uniqueness even if same image is sent multiple times
            final id =
                '${session.id}_${message.timestamp.millisecondsSinceEpoch}_${img.hashCode}_$imgIndex';
            imgIndex++;
